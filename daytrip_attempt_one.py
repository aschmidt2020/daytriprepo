...
def random_choice_correct(random_choice, choice_list):
    ...
    while correct != 'Yes':
        new_choice = random.choice(choice_list)
...
final_destination = random_choice_correct(random_choice_destination, destinations)
final_restaurant = random_choice_correct(random_choice_restaurants, restaurants)
final_transport = random_choice_correct(random_choice_transport, mode_of_transport)
final_entertainment = random_choice_correct(random_choice_entertainment, entertainments)
